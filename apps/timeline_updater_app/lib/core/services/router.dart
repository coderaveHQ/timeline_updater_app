...
import 'package:timeline_updater_app/src/features/main/presentation/pages/main_page.dart';
import 'package:timeline_updater_app/src/features/settings/presentation/pages/settings_page.dart';
import 'package:timeline_updater_app/src/features/standards/presentation/pages/standards_page.dart';
import 'package:timeline_updater_app/src/features/updates/presentation/pages/updates_page.dart';
...
@TypedShellRoute<MainRoute>(
  routes: [
    ...
    TypedGoRoute<StandardsRoute>(path: StandardsRoute.location),
...
/// The standards route
class StandardsRoute extends GoRouteData {

  /// The location of the route
  static const String location = '/standards';
  ...
  Page<void> buildPage(BuildContext context, GoRouterState state) {
    return NoTransitionPage(
      key: state.pageKey,
      child: const StandardsPage()
    );
  }
}

/// The upload standard route
@TypedGoRoute<UploadStandardRoute>(path: UploadStandardRoute.path)
class UploadStandardRoute extends GoRouteData {

  /// The location of the route
  static const String location = 'upload';

  /// The full path of the route
  static const String path = '${ StandardsRoute.location }/$location';
  ...
  Page<void> buildPage(BuildContext context, GoRouterState state) {
    return TLDialogPage(
      builder: (BuildContext context) => const UploadStandardDialog()
    );
  }
}
